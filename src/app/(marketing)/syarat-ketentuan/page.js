  ...
  return (
    <div className="container py-5" style={{ maxWidth: 800 }}>
      ...
      <p>
        ...
        halaman Paket. Garansi mencakup perbaikan bug pada fitur yang sudah
        disepakati, dan tidak mencakup permintaan desain atau fitur baru di
        luar cakupan paket yang dipilih.
      </p>

      <h4 className="fw-bold mt-4">6. Kepemilikan Domain</h4>
      <p>
        Domain website didaftarkan menggunakan akun milik klien sendiri.
        Tyrexion hanya membantu proses pengaturan (setup) domain tersebut.
      </p>

      <h4 className="fw-bold mt-4">7. Pembatalan</h4>
      <p>
      ...
      <h4 className="fw-bold mt-4">8. Batasan Tanggung Jawab</h4>
      <p>
